...
public interface Grafo {
     ...
     * @param origem
     * @param destino
     * @throws java.lang.Exception Uma exceção é lançada quando não é possível
     * adicionar aresta entre origem e destino, de acordo com limitações da
     ...
     * @param origem
     * @param destino
     * @return True, se existe aresta entre origem e destino, False, caso
     * contrário.
     ...
     * @throws java.lang.Exception Uma exceção é lançada quando o vértice
     * indicado não existe.
     */
